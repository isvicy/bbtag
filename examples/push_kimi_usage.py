#!/usr/bin/env python3
"""Render Kimi Code CLI usage in a compact /stats-like layout for 2.13-inch tags.
...
示例:
    ...
    uv run examples/push_kimi_usage.py --device EDP-F3F4F5F6
    uv run examples/push_kimi_usage.py --input-json sample_usage.json --preview-only
"""
...
USAGE_PATH = "/usages"
DEFAULT_OUTPUT = "kimi-usage-2.13inch.png"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="把 Kimi Code usage 画成 2.13 寸电子价签样式并推送。",
    )
    parser.add_argument(
        "--screen",
